...
PATH = HOME_PATH/"MyLayerTest/IMAGENET"
...
parser.add_argument("--epochs", default=20, type=int, dest="epochs")

parser.add_argument("--data_dir", default=DATA_PATH/"imagenet", type=str, dest="data_dir")
...
parser.add_argument("--eval_every", default=1000, type=int, dest="eval_every")
parser.add_argument("--save_image_num", default=1, type=int, dest="save_image_num")
parser.add_argument("--print_every", default=100, type=int, dest="print_every")

parser.add_argument("--batch_amount", default=100, type=int, dest="batch_amount")
...
parser.add_argument("--transfer_th", default=None, type=str)
...
if __name__ == "__main__":
    ...
    if args.thlist_flag:
        ...
        # thlist = [1,-1] # 0-pretrain 1-alpha -1:all
        # netlist = ["resnet50","vgg16", "vgg19","resnet18","mobilenet_v2", "efficientnetb0", "resnet34", "googlenet", "alexnet", "inception_v3"]
